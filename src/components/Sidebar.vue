      ...
      <div class="flex flex-col h-full overflow-y-auto flex-grow pt-2 justify-between">
        <div class="flex flex-col space-y-1 mx-1 lg:mt-1">
          ...
          >
            ...
            <span v-if="!isCollapsed" class="lg:block hover:text-orange-300">Accueil</span>
          </router-link>
        ...
        <div class="flex flex-col space-y-1 mx-1 lg:mt-1">
          <router-link
            to="/admin"
            :class="[
              'flex items-center h-12 rounded-md font-semibold text-gray-500 hover:text-primary-400 cursor-pointer overflow-hidden',
          ...
          >
            ...
            <span v-if="!isCollapsed" class="ml-2 text-sm truncate">Settings</span>
          </router-link>
        </div>
      </div>
